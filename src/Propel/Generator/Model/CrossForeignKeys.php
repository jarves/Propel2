...
class CrossForeignKeys
{
     ...
     *
     *  isAtLeastOneLocalPrimaryIsNotCovered(FK1) where none fks in our collection: true
     *  isAtLeastOneLocalPrimaryIsNotCovered(FK2) where FK1 is in our collection: true
     *  isAtLeastOneLocalPrimaryIsNotCovered(FK3) where FK1,FK2 is in our collection: false
     *  isAtLeastOneLocalPrimaryIsNotCovered(FK4) where FK1,FK2 is in our collection: true
     *
     * @param ForeignKey $fk
     * @return bool
     */
